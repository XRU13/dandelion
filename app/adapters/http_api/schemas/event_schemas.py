...
class EventDetails(BaseModel):
    ...
    level_id: int | None = Field(None, description="ID уровня для complete_level")
...
class EventRequest(BaseModel):
    ...
    details: EventDetails | None = Field(None, description="Дополнительные данные события")
...
class EventResponse(BaseModel):
    ...
    details: EventDetails | None = Field(None, description="Дополнительные данные")
