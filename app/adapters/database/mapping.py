from app.application.entities import (
    User, Event, UserScore, Achievement, 
    UserAchievement, AchievementNotification
)
from .tables import (
    mapper_registry, users_table, events_table, user_scores_table,
    achievements_table, user_achievements_table, achievement_notifications_table
)
...
def configure_mappers():
    ...
    mapper_registry.map_imperatively(AchievementNotification, achievement_notifications_table) 