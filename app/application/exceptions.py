...
class UserAlreadyExistsError(AppError):
	"""Исключение для случая когда с таким email пользователь уже существует"""
	msg_template = "Пользователь с email '{email}' уже существует"
	code = 'user_service.email_already_exists'
